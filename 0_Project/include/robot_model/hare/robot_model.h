...
public:
    RobotModel() : RobotParameters()
    {
        ...
        strcpy(robot_info.robot_name, "hare");
        strcpy(robot_info.robot_description ,  "this is a differential4 template robot of handsfree");
        ...
        chassis_para.type = DIFFERENTIAL4;
        chassis_para.wheel_radius = 0.1025;
        chassis_para.body_radius = 0.531; //a+b 0.21 + 0.275
        chassis_para.speed_low_filter = 0.5;
        chassis_para.imu_fusion_enalbe = 0;
        chassis_para.control_enable = 1;
        chassis_para.max_speed_limit.x = 5;
