...
/***********************************************************************************************************************
* Function:    ErrorStatus RTC_Set_Date(unsigned char year,unsigned char month,unsigned char date,unsigned char week)
* 
* Scope:      
* 
...
/***********************************************************************************************************************
* Function:    void RTC_Get_Time(unsigned char *hour,unsigned char *min,unsigned char *sec,unsigned char *ampm)
* 
* Scope:      
* 
...
* by   mawenke   2015.12.1  update     
***********************************************************************************************************************/
void RTC_Get_Time(volatile unsigned char *hour,volatile unsigned char *min,volatile unsigned char *sec,volatile unsigned char *ampm)
{
...
/***********************************************************************************************************************
* Function:    void RTC_Get_Date(unsigned char *year,unsigned char *month,unsigned char *date,unsigned char *week)
* 
* Scope:      
* 
...
* by   mawenke   2015.12.1  update 
***********************************************************************************************************************/
void RTC_Get_Date(volatile unsigned char *year,volatile unsigned char *month,volatile unsigned char *date,volatile unsigned char *week)
{
...
/***********************************************************************************************************************
* Function:    unsigned char HF_RTC_Init(void)
* 
* Scope:      
* 
* Description: 
...
* by   Lidexin   2016.1.10  change the type of returned value
***********************************************************************************************************************/
...
/***********************************************************************************************************************
* Function:    void RTC_Set_AlarmA(unsigned char week,unsigned char hour,unsigned char min,unsigned char sec)
* 
* Scope:      
* 
...
* History: 
* by   mawenke   2015.12.1  update   
* by   Lidexin   2016.1.16  debug
***********************************************************************************************************************/
void HF_RTC_Time_Renew(void)
{
