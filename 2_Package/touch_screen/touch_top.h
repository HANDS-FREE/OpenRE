...
//电阻/电容屏芯片连接引脚	   
#define PEN  		PEin(4)   	//PF10 INT
#define DOUT 		PEin(3)   	//PB2  MISO
#define TDIN 		PEout(2)  	//PF9  MOSI
#define TCLK 		PEout(0)  	//PB1  SCLK
#define TCS  		PDout(13)  	//PF11  CS 
 
//24cxx 保存在EEPROM里面的地址区间基址,占用14个字节(RANGE:SAVE_ADDR_BASE~SAVE_ADDR_BASE+13)
