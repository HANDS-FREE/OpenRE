...
ASM_SRC     += $(UCOSIII_PATH)/uC-CPU/ARM-Cortex-M3/GNU/cpu_a.s 
C_SRC     	+= $(UCOSIII_PATH)/uC-CPU/cpu_core.c \
               $(UCOSIII_PATH)/uC-CPU/ARM-Cortex-M3/GNU/cpu_c.c 

ASM_SRC     += $(UCOSIII_PATH)/uC-LIB/Ports/ARM-Cortex-M3/GNU/lib_mem_a.s \               
...
ASM_SRC     += $(UCOSIII_PATH)/uCOS-III/Ports/ARM-Cortex-M3/Generic/GNU/gnu_os_cpu_a.s

C_SRC     	+= $(UCOSIII_PATH)/uCOS-III/Ports/ARM-Cortex-M3/Generic/GNU/os_cpu_c.c

C_SRC     	+= $(UCOSIII_PATH)/uCOS-CONFIG/os_app_hooks.c 

#Includes
INCDIR      += -I$(UCOSIII_PATH)/uC-CPU \
            -I$(UCOSIII_PATH)/uC-CPU/ARM-Cortex-M3/GNU \
            -I$(UCOSIII_PATH)/uC-LIB \
            -I$(UCOSIII_PATH)/uC-LIB/Ports/ARM-Cortex-M3/GNU \
            -I$(UCOSIII_PATH)/uCOS-III/Ports/ARM-Cortex-M3/Generic/GNU  \
